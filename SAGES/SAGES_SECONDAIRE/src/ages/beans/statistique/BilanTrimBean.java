...
@ManagedBean(name="bilanTrimBean")
@ViewScoped
public class BilanTrimBean extends GenericBean implements Serializable{
	...
	public void initBilan(){
		...
		if(trim==0){
			Repertoire.addMessageerreurParametreRequis("Trimestre");
			return;
		}*/
		loaded=this.service.initbilanTrim(this);
	}
