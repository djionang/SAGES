...
public class Service implements Serializable{
	...
	private String getLoginUser() throws UnknownUserException{
	    ...
	    if(user!=null)
	    	...
	    	throw new  UnknownUserException(" Utilisateur non reconnu, acces aux services refusé");
	...
	private void initSession(Utilisateur user, String annee,String loginadmin, String passadmin) throws EtablissementUndefinedException{
	    ...
	    try {
			...
			Repertoire.addMessageerreur("Impossible de déterminer l'année scolaire");
			e.printStackTrace();
		}
	...
	public void initDossierBean(DossierBean dossier){
		...
		if(!CopyUtil.copiePreinscriptionToDossierBean(dossier,preins)){
			Repertoire.logInfo("Copie de dossier a dossierBean déroulé avec echec", utils.CopyUtil.class);
		}
	}
	 ...
	 * @param matricule de l'eleve recherché
	 * @return
	 */
	...
	/**
	 * Recherche les informations sur l'établissement dans la base de données
	...
	/**
	 * retourne la liste de toutes les candidatures enregistrées
	 * @return
	 */
	...
	/**
	 * Retourne la liste de toutes les candidatures acceptées
	 * @return
	 */
	...
	/**
	 * Liste des types de salles déja enregistrés dans la BD
	 * @return
	 */
	...
	/**
	 * Liste des options enregistrées
	 * @return la liste
	 */
	...
	/**
	 * Liste les differents types de tranches déja enregistrés
	 * @return la liste des types de transches présents dans la base
	 */
	...
	/**
	 * Liste les parametres de tranches enregistrés pour une salle de classe
...
//				liste.add(new ClasseBean());
	...
	/**
	 * Liste les codes et libellés des sections
	 * @return
	 */
	...
	/**
	 * Enregistre une inscription d'un nouvel élève
	...
	public String saveInscription(float montantVerse, String matricule, String typeversement,Date dateVersement) throws ElementNOtFoundException, MontantInscriptionInsuffisant, EleveDSCompletException, JPAException, DroitsScolairesNonDefinis, TotalVersementExcedantException{
		// dans l'EJB, répartir le montant suivant les parametres tranches de la classe, jusqu'a un certain niveau.
	...
	/**
	 * Enregistre le versement de droits scolaires pour un élève
	 * @param montantVerse montant versé par l'élève
	 ...
	 * @param dossier bean de l'IHM recupéré
	 ...
	 * Rends persistant le code, l'option, le libellé, la contenance maximale et l'année académique
	 * @param salleDefaut 
	 * @param classe
	 * @return
	 * @throws ElementNOtFoundException 
	 * @throws ages.exception.DuplicateKeyException 
	 * @throws AnneeEnCoursNonDefinieException  aucune année en cours paramétrée
	 */
	...
	/**
	 * Retourne l'année académique en cours, cele définie par l'administrateur
	 * @return
	 */
	...
	/**
	 * Vérifie qu'un élève est déja inscrit pour l'année en cours
	 * @param matricule Matricule de l'élève dont on veut vérifier l'inscription
	 * @return true si l'eleve de matricule passé en paramètre est inscrit, false sinon
	 * @throws ElementNOtFoundException 
	 */
	 ...
	 * @param classe Boolean indiquent si le transfert vers une classe a été éffectué(true) ou non
	 * @return
	...
	public void modifyAnnee(String anneeacademique, Date datedebut, Date datefin) throws ElementNOtFoundException, ChevauchementDateException {
		...
		try {
			...
			Repertoire.addMessageerreur("Etablissement non défini");
			e.printStackTrace();
		}
	}
	 ...
	 * @throws ElementNOtFoundException renvoyée au cas où levaluation n'existe pas
	 * @throws PourcentageEvaluationExedantException renvoyée au cas où la somme totale des coefficients, le nouveau coefficient compris dépasse les 100%
	 * @throws CoursNonDefiniException renvoyée au cas ou le cours correspondant n' pas encore été défini
	 */
	 ...
	 * @param typeevaluation libellé du type à supprimer
	 * @throws ElementNOtFoundException renvoyée au cas où le type n'existe pas
	 */
	...
	/**
	 * Sauvegarder un type d'évaluation
	 * @param typeevaluation libellé du type
	 * @param coefficient coefficient sur la note finale
	 * @param description description du type
	 * @throws ages.exception.DuplicateKeyException renvoyé i le type existe déja
	 */
	...
	/**
	 * Liste des types d'évaluation enregistrés
	 * @return
	 */
	...
	/**
	 * Liste des années académiques  enregistrées jusqu'ici
	 * @return
	 */
	...
	/**
	 * Justifier l'absence de plusieurs élèves a une évaluation
	 * @param evaluation evaluation dite
	 * @param eleveschoisis élèves voulant de justifier
	...
	/**
	 * Annuler la justification d'une absence à un examen
	 * @param evaluation evaluation dite
	 * @param eleveschoisis liste d'élèves dont on veut annuler la justification
	 * @throws ElementNOtFoundException 
	 */
	...
	/**
	 * Liste les évaluations d'une classe pour une sequence
	 * @param codesequence sequence
	 * @param codeclasse classe
	 * @return la liste des évaluation programmées pour la classe de code codeclasse, pendant la sequence codesequence
	 */
	...
	/**
	 * Liste les évaluations d'une sequence, pour une classe et une matiere données
	 * @param codesequence
	 * @param codeclasse
	 * @param codematiere
	 * @return
	...
	/**
	 * Liste des eleves ayant justifié leurs absence a une evaluation
	 * @param codesequence
	 * @param evaluation
	 * @param codeclasse
	 * @return
	...
	public List<EleveBean> listerElevesJustifies(int codesequence,
		...
		//rechercher dans la base les gars qui ont justifié leurs absences a levaluation
	...
	/**
	 * Initialise le bean NotesBean de la liste des notes des élèves pour une évaluation
	 * @param notesBean
	 */
	 ...
	 * @param compositions liste des eleves et leurs notes encapsulées dans une classe cdomposition
	 * @param codeevaluation code de l'évaluation concernée
	 * @throws ElementNOtFoundException renvoyée si un des élèves ou l'évaluation n'est pas retrouvée
	 */
	public String enregistrerNotes(List<CompositionBean> compositions,int codeevaluation) throws ElementNOtFoundException, Exception {
		...
		for(int i=0;i<compositions.size();i++){
			// nous vérifions ici si la note est comprise dans la fourchette voulue
	 ...
	 * @throws AddressException adresse invalide envoyée
	 * @throws AdminstrateurNotFoundException aucun administrateur trouvé
	 */
	...
	public Boolean connectUser(UserBean userBean) throws EtablissementUndefinedException {
		...
		//Pour cela recherche la configuration de l'application qui contient l'administrateur général
		Configuration conf=getUtilitaire().rechercherConfiguration();
		
		
		if(conf!=null && conf.getLogin_admin().compareTo(userBean.getLogin())==0){
			// Cas où l'utilisateur est l'administrateur général
	...
	/**
	 * Initialise les données de compte d'un utilisateur
	 ...
	 * @return l'id du groupe enregistré
	 * @throws DuplicateKeyException propagée si un groupe utilisateur
	 * @throws ElementNOtFoundException Propagée si un ou plusieurs roles n'ont pas été trouvé
	 */
	...
	public void initCompte(CompteBean cb) {
		...
		if(user==null) // si l'utilisateur n'est pas retrouvé
			return;
...
//				liste.add(new ClasseBean());
	...
	public ScheduleModel listerProgrammationClasse(String codeclasse) {
		...
		try {
			...
			Repertoire.addMessageerreur("Aucune année en cours trouvée", e);
			return null;
		}
	...
	/**
	 * Imprimmer les notes d'une classe (exporter en PDF) pour une évaluation donnée
	 * @param codeevaluation code de l'évaluation
	 * @throws IOException
	 * @throws JRException
	 */
	 ...
	 * @param codematiere code de la matiere concernée
	 * @param codeclasse code de la classe concernée
	 * @return le libelle du cours liant la matiere "codematiere" à la classe "codeclasse"
	 */
	...
	/**
	 * Dit si oui ou non un utilisateur a le droit de modifier les notes d'une évaluation
	 * @param codeevaluation code de l'évaluation concernée
	 * @return true si l'utilisateur courant possede les droits de modification, false sinon
	 * @throws ElementNOtFoundException propagée si l'évaluation de code passé en parametres n'est pas retrouvée
	 */
